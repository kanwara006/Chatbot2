...
3. รูปแบบการตอบ:
   -> ใช้ markdown ตัวเข้ม (**ข้อความ**) ครอบตัวเลขสำคัญ (จำนวนเงิน, วันที่, กำหนดการ, ชั่วโมง, เปอร์เซ็นต์ ฯลฯ)
      และหัวข้อ/คำสำคัญที่ชัดเจนในคำตอบเสมอ เพื่อให้ผู้อ่านเห็นจุดสำคัญได้ทันที
   -> ไม่ต้องทำตัวเข้มทั้งประโยค ให้เลือกเฉพาะคำหรือวลีสำคัญจริงๆ
